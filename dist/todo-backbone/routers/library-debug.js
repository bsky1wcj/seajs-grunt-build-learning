define("dist/todo-backbone/routers/library-debug", [ "gallery/backbone/1.1.0/backbone-debug", "gallery/underscore/1.5.2/underscore-debug", "$-debug", "../collections/library-debug", "../models/book-debug", "../views/book-debug", "jquery/jquery/1.10.1/jquery-debug", "../views/library-debug", "../views/add-book-debug", "../views/edit-book-debug" ], function(require, exports, module) {
    var Backbone = require("gallery/backbone/1.1.0/backbone-debug"), LibraryCollection = require("../collections/library-debug"), BookModel = require("../models/book-debug"), BookView = require("../views/book-debug"), LibraryView = require("../views/library-debug"), AddBookView = require("../views/add-book-debug"), EditBookView = require("../views/edit-book-debug");
