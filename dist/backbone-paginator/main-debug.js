define("dist/backbone-paginator/main-debug", [ "gallery/backbone/1.1.0/backbone-debug", "gallery/underscore/1.5.2/underscore-debug", "$-debug", "willkan/backbone-localStorage/1.1.6/backbone.localStorage-debug", "jquery/jquery/1.10.1/jquery-debug" ], function(require) {
    var Backbone = require("gallery/backbone/1.1.0/backbone-debug"), BackboneLocalStorage = require("willkan/backbone-localStorage/1.1.6/backbone.localStorage-debug"), $ = require("jquery/jquery/1.10.1/jquery-debug"), _ = require("gallery/underscore/1.5.2/underscore-debug");
    //Models
    ...
    var BookCollection = Backbone.Collection.extend({
        // url: 'server/list.php',
        localStorage: new BackboneLocalStorage("books-backbone"),
        model: BookModel,
        initialize: function() {
    ...
    var BookListView = Backbone.View.extend({
        ...
        initialize: function(options) {
            console.log("BookListView-initialize", options.page);
        ...
        render: function() {
            console.log("BookListView-render", this.options);
    ...
    var BookListItemView = Backbone.View.extend({
        ...
        deleteBook: function(event) {
            var self = this, _id = this.model.id;
    ...
    var Paginator = Backbone.View.extend({
        ...
        render: function() {
            ...
            var pageCount = Math.ceil(len / this.options.pageSize);
    ...
    var BookRouter = Backbone.Router.extend({
        ...
        list: function(page) {
            ...
            var self = this, p = page ? parseInt(page, 10) : 1;
            ...
            this.bookList.fetch({
                ...
                // },
                success: function() {
                    self.bookListView = new BookListView({
